// src/connectors/markdown/figure_pair.hpp — declare Markdown lowering for figure pairs.
#ifndef DANS_TYPESETTING_SRC_CONNECTORS_MARKDOWN_FIGURE_PAIR_HPP
#define DANS_TYPESETTING_SRC_CONNECTORS_MARKDOWN_FIGURE_PAIR_HPP
...
{
class FigurePairMarkdownAdapter final : public writers::MarkdownBlockAdapter
{
  public:
    explicit FigurePairMarkdownAdapter(
...
#endif  // DANS_TYPESETTING_SRC_CONNECTORS_MARKDOWN_FIGURE_PAIR_HPP
